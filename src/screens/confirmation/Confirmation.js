...
class Confirmation extends Component {
  ...
  componentDidMount() {
    ...
    currentState.totalPrice = currentState.originalTotalPrice =
      parseInt(this.props.bookingSummary.unitPrice, 10) *
      parseInt(this.props.bookingSummary.tickets, 10);
  ...
  couponApplyHandler = () => {
    ...
    if (couponObj !== undefined && couponObj.value > 0) {
      currentState.totalPrice =
        this.state.originalTotalPrice -
        (this.state.originalTotalPrice * couponObj.value) / 100;
            ...
            <Card className="cardStyle">
              <CardContent>
                ...
                <div className="coupon-container">
                  ...
                  <div>
                    <Typography>
                      {this.props.bookingSummary.unitPrice}
                    </Typography>
                  </div>
                </div>
                <br />
